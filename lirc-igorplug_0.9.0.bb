...
PACKAGES =+ "lirc-igorplug-x"

FILES_lirc-igorplug-x = "${bindir}/irxevent ${bindir}/xmode2"
...
S = "${WORKDIR}/lirc-${PV}"
EXTRA_OECONF = "--with-kerneldir=${STAGING_KERNEL_DIR} --with-igor --with-driver=igorplugusb"